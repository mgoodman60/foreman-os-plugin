...
- For field reference knowledge (trade sequencing, site logistics, activity-specific constraints), install the foremanos-field plugin which includes 21 trade-specific reference guides
