...
- `${CLAUDE_PLUGIN_ROOT}/skills/estimating-intelligence/SKILL.md` — Unit cost validation and pricing review for change order cost evaluation (stub — full skill in foremanos-intel)
